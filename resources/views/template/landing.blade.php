        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
            <div class="flex items-center justify-between h-16">
                <div class="flex-shrink-0">
                    <a href="#" class="font-bold text-gray-600 text-2xl"><i class="fa-solid fa-meteor"></i> Ask.me</a>
                </div>
                <div class="hidden md:flex items-center ml-auto">
                    <a href="{{ route('login') }}" class="text-gray-500 ml-10 rounded-md hover:text-blue-600"><i class="fa-solid fa-right-to-bracket text-2xl"></i></a>
                </div>
                <div class="md:hidden">
